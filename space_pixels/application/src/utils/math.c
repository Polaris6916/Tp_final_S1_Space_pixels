...
{
    float longueur = v.x * v.x + v.y * v.y;
    return longueur;
}
...
{
    float longueur = (v1.x - v2.x) * (v1.x - v2.x) + (v1.y - v2.y) * (v1.y - v2.y);
    return longueur;
}

float Vec2_distance(Vec2 v1, Vec2 v2)
{
    float longueur = sqrt(Vec2_distanceSquared(v1, v2));
    return longueur;
}
...
{
    float valeur = v1.x * v2.x + v1.y * v2.y;
    return valeur;
}
// END TODO
//==============================================================================
