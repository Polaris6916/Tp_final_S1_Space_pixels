...
void Game_addAssets(AssetManager *assets)
{
    ...
    AssetManager_addSpriteSheet(
        ...
        ASSETS_PATH, "player/player_dash.dat", 1, 64, 64
    );
    AssetManager_addSpriteSheet(
    ...
    AssetManager_addSpriteSheet(
        ...
        ASSETS_PATH, "player/player_dying.dat", 6, 62, 62
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_PLAYER_HEALTH,
        ASSETS_PATH, "health/health_bar_player.dat", 8, 48, 32
    );
    //*/
    // Ennemy
    AssetManager_addSpriteSheet(
        assets, SPRITE_ENNEMY_HEALTH,
        ASSETS_PATH, "health/health_bar_ennemy.dat", 6, 48, 32
    );
    ...
    AssetManager_addSpriteSheet(
        ...
        ASSETS_PATH, "player/dash_shield.dat", 10, 64, 64
    );
    //*/
    //* TODO 14: Tir d'un ennemi
    AssetManager_addSpriteSheet(
        assets, SPRITE_BULLET_FIGHTER,
        ASSETS_PATH, "enemy/fighter/fighter_bullet.dat", 4, 4, 16
    );
    //*/
    AssetManager_addSpriteSheet(
        assets, SPRITE_BULLET_TORPEDO,
        ASSETS_PATH, "enemy/torpedo/torpedo_bullet.dat", 3, 11, 32
    );

    AssetManager_addSpriteSheet(
        assets, SPRITE_BULLET_BATTLECRUISER,
        ASSETS_PATH, "enemy/battlecruiser/battlecruiser_bullet.dat", 6, 64, 64
    );

    AssetManager_addSpriteSheet(
        assets, SPRITE_BULLET_FRIGATE,
        ASSETS_PATH, "enemy/frigate/frigate_bullet.dat", 3, 11, 32
    );
    ...
    AssetManager_addSpriteSheet(
        ...
        ASSETS_PATH, "enemy/fighter/fighter_firing.dat", 6, 64, 64
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_FIGHTER_DYING,
        ASSETS_PATH, "enemy/fighter/fighter_dying.dat", 9, 64, 64
    );
    //*/
    //Scout
    AssetManager_addSpriteSheet(
        assets, SPRITE_SCOUT_FIRING,
        ASSETS_PATH, "enemy/scout/scout_firing.dat", 6, 64, 64
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_SCOUT_DYING,
        ASSETS_PATH, "enemy/scout/scout_dying.dat", 9, 64, 64
    );

    //Torpedo
    AssetManager_addSpriteSheet(
        assets, SPRITE_TORPEDO_FIRING,
        ASSETS_PATH, "enemy/torpedo/torpedo_firing.dat", 16, 64, 64
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_TORPEDO_DYING,
        ASSETS_PATH, "enemy/torpedo/torpedo_dying.dat", 9, 64, 64
    );
    //Battlecruiser
    AssetManager_addSpriteSheet(
        assets, SPRITE_BATTLECRUISER_FIRING,
        ASSETS_PATH, "enemy/battlecruiser/battlecruiser_firing.dat", 30, 128, 128
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_BATTLECRUISER_DYING,
        ASSETS_PATH, "enemy/battlecruiser/battlecruiser_dying.dat", 14, 128, 128
    );

    //Frigate
    AssetManager_addSpriteSheet(
        assets, SPRITE_FRIGATE_FIRING,
        ASSETS_PATH, "enemy/frigate/frigate_firing.dat", 6, 64, 64
    );
    AssetManager_addSpriteSheet(
        assets, SPRITE_FRIGATE_DYING,
        ASSETS_PATH, "enemy/frigate/frigate_dying.dat", 9, 64, 64
    );
