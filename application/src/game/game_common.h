...
typedef enum SpriteID
{
    ...
    SPRITE_PLAYER_DYING,
    SPRITE_PLAYER_HEALTH,
    //
    SPRITE_PLAYER,
    SPRITE_PLAYER_DASH,
    //
    SPRITE_BULLET_PLAYER_DEFAULT,
    SPRITE_BULLET_PLAYER_DASH,
    SPRITE_BULLET_FIGHTER,
    SPRITE_BULLET_TORPEDO,
    SPRITE_BULLET_BATTLECRUISER,
    SPRITE_BULLET_FRIGATE,
    //
    SPRITE_FIGHTER_FIRING,
    SPRITE_FIGHTER_DYING,
    SPRITE_ENNEMY_HEALTH,
    //
    SPRITE_SCOUT_FIRING,
    SPRITE_SCOUT_DYING,
    //
    SPRITE_TORPEDO_FIRING,
    SPRITE_TORPEDO_DYING,
    //
    SPRITE_BATTLECRUISER_FIRING,
    SPRITE_BATTLECRUISER_DYING,
    //
    SPRITE_FRIGATE_FIRING,
    SPRITE_FRIGATE_DYING,
    //
